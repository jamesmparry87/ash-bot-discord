    ...
    async def _add_game(self, ctx, entry: str):
        ...
        try:
            ...
            if added:
                ...
                # Update the persistent recommendations list (only if in a guild)
                if ctx.guild:
                    ...
                    if db_episodes > youtube_episodes:
                        ...
                        if fix_discrepancies:
                            ...
                            if success:
                                fixed_count += 1
                                print(
                                    f"✅ VERIFY: Fixed {game_name} - {db_episodes}→{youtube_episodes} episodes, refreshed views and playtime")
                            else:
