...
FAQ_DATA = {"strikes": {"patterns": ["explain strikes",
            ...
            "database": {"patterns": ["explain database",
                         ...
                         "sections": [{"title": "Purpose",
                                      ...
                                      {"title": "Import System",
                                       "content": ["• `!syncgames` — YouTube playlists + Twitch VODs with real playtime",
                                                   "• `!enrichallgames` — AI metadata enhancement for existing games",
                                                   "• `!cleandatabase` — Re-validate all game titles against IGDB",
                                                   ],
                                       },
                         ...
                         "sections": [{"title": "Architecture",
                                      ...
                                      {"title": "Moderator Commands (Manage Messages required)",
                                       "content": ["• **Strike Management:** `!strikes`, `!resetstrikes`, `!allstrikes`",
                                                   ...
                                                   "• **Database Operations:** `!cleandatabase`, `!deduplicategames`",
                                      ...
                                      {"title": "Elite Access (Captain Jonesy & Sir Decent Jam)",
                                       "content": ["• **Announcement System:** `!announce`, `!announceupdate`, `!emergency`",
                                                   "• **Content Sync:** `!syncgames`, `!syncgames <days>`, `!syncgames full`, `!syncgames verify`, `!syncgames verify --fix`",
                                                   "• **VOD Naming:** `!namevod <url_or_id> <game name>` — retroactively name a timed-out VOD",
                                                   "• **Sync Help:** `!synchelp` — full command reference for the sync system",
                                                   "• **Maintenance:** `!enrichallgames`, `!deduplicategames`",
            ...
            "import": {"patterns": ["explain import",
                       ...
                       "sections": [{"title": "Purpose",
                                    ...
                                    {"title": "Commands",
                                     "content": ["• `!syncgames` — Full import from APIs with AI metadata",
                                                 "• `!enrichallgames` — AI enhancement for existing games",
                                                 "• `!cleandatabase` — Re-validate all game titles against IGDB",
                                                 ],
                                     },
            ...
            "sync": {"patterns": ["syncgames",
                                  ...
                                  "enrich all games",
                                  "synchelp"],
                     "title": "🔄 **Content Sync System Analysis**",
                     "sections": [{"title": "Quick Reference",
                                   "content": "Use `!synchelp` in any channel to get the full command reference sent to you immediately.",
                                   },
                                  {"title": "Running a Sync",
                                   "content": ["• `!syncgames` — Standard sync: picks up new YouTube playlists and Twitch VODs since the last run",
                                               ...
                                               "• ⚠️ **During any sync:** Watch your DMs — Twitch VODs whose title doesn't contain the game name will be sent to you for manual naming",
                                               ],
                                   },
                                  {"title": "Handling Unnamed VODs (!namevod)",
                                   "content": ["• `!namevod <twitch_url_or_id> <game name>` — Retroactively name a VOD that timed out during sync",
                                               "• If the game exists in the DB → updated directly, no approval needed",
                                  ...
                                  {"title": "Post-Sync Summary DM",
                                   "content": ["• After every sync completes, you receive a DM listing:",
                                               "  – Games staged for approval (new vs updated)",
                                               "  – VODs that timed out (will be offered again next sync)",
                                               "  – VODs you permanently skipped",
                                               ],
                                   },
                                  {"title": "Verifying Episode Counts",
                                   "content": ["• `!syncgames verify` — Check DB episode counts against live YouTube data",
                                               "• `!syncgames verify --fix` — Find AND fix discrepancies using fresh YouTube data",
                                               ],
                                   },
                                  {"title": "One-Time / Maintenance Commands",
                                   "content": ["• `!enrichallgames` — Bulk-enrich ALL games with IGDB data (genre, release year, alt names). Run once after a major import.",
                                               "• `!deduplicategames` — Merge duplicate game entries in the database",
                                               ],
                                   },
                                  {"title": "Access Control",
                                   "content": "All sync commands are restricted to Captain Jonesy and Sir Decent Jam only.",
                                   },
                                  ],
                     },
            }
