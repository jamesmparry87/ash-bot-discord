...
# Global approval queue for JAM (prevents conversation collisions)
jam_approval_queue: list[Dict[str, Any]] = []

# Track if JAM currently has an active approval conversation
jam_approval_active: bool = False
...
# ============================================================================
# CONVERSATION SAFETY WRAPPER (Fix #1)
# ============================================================================
        ...
        if step == 'approval':
            ...
            if content in ['1', 'approve', 'yes', 'accept']:
                ...
                if rejected_category and items_to_remove:
                    ...
                    print(f"🗑️ Removed {len(items_to_remove)} pending questions of rejected category '{rejected_category}' from the queue.")
