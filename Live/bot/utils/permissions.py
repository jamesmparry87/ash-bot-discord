...
def should_limit_member_conversation(user_id: int, channel_id: Optional[int]) -> bool:
...
async def user_is_mod_by_id(user_id: int, bot: Optional[commands.Bot] = None) -> bool:
...
async def user_is_member_by_id(user_id: int, bot: Optional[commands.Bot] = None) -> bool:
...
async def get_user_communication_tier(message_or_ctx, bot: Optional[commands.Bot] = None) -> str:
