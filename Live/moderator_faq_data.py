...
FAQ_DATA = {"strikes": {"patterns": ["explain strikes",
            ...
            "recommendations": {"patterns": ["explain recommendations",
              ...
              "sections": [
                     ...
                     "content": [
                            "Any user can set a personal reminder using natural language. The bot will send you a Direct Message (DM) when the time comes.",
                     ...
                     "content": [
                            "• `!remind @user 2h to check on your report` — Sends a DM reminder to a specific user.",
                     ...
                     "content": [
                            "• **Natural Language:** `in 5 minutes`, `10m`, `2 hours`, `1h`, `tomorrow at noon`, `next Tuesday at 8pm`",
                     ...
                     "content": [
                            "Auto-actions can be attached to reminders set for a specific user.",
                     ...
                     "content": [
                            "• `!listreminders [@user]` — Shows your pending reminders (or a specific user's if you are a mod).",
