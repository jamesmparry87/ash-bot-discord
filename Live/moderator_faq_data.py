...
FAQ_DATA = {"strikes": {"patterns": ["explain strikes",
            ...
            "game_queries": {"patterns": ["explain game queries",
                                          "natural language",
                                          "ask ash",
                                          "game questions"],
                             "title": "🎮 **Natural Language Game Query System Analysis**",
                             "sections": [{"title": "Purpose",
                                           "content": "Intelligent natural language processing for gaming database queries with contextual follow-up suggestions.",
                                           },
                                          {"title": "Basic Game Lookup Queries",
                                           "content": ["• `@Ashbot Has Jonesy played [game name]?` — Query played games database",
                                                       "• `@Ashbot What games has Jonesy played?` — Get database examples",
                                                       "• **Smart Disambiguation:** For series names, Ash asks for clarification",
                                                       "• **Contextual Follow-ups:** Suggests related queries based on results",
                                                       ],
                                           },
                                          {"title": "Genre & Series Queries",
                                           "content": ["• `@Ashbot What horror games has Jonesy played?` — Query by genre",
                                                       "• `@Ashbot What Final Fantasy games has Jonesy played?` — Query by series",
                                                       "• **Completion Status:** Shows progress (completed, ongoing, dropped)",
                                                       "• **Episode Counts:** Displays number of episodes per game",
                                                       ],
                                           },
                                          {"title": "Statistical Analysis Queries",
                                           "content": ["• `@Ashbot What game series has the most playtime?` — Series rankings",
                                                       "• `@Ashbot Which game has the most episodes?` — Episode count analysis",
                                                       "• `@Ashbot What game took longest to complete?` — Completion time metrics",
                                                       "• `@Ashbot What game has highest average playtime per episode?` — Efficiency analysis",
                                                       ],
                                           },
                                          {"title": "Smart Follow-up System",
                                           "content": ["• **Series Analysis:** 'I could analyze her complete [Series] chronology...'",
                                                       "• **Episode Insights:** 'This ranks #2 in episode count metrics...'",
                                                       "• **Completion Tracking:** 'I can track progress against typical metrics...'",
                                                       "• **Efficiency Analysis:** 'Efficient completion detected...'",
                                                       ],
                                           },
                                          {"title": "Query Processing",
                                           "content": "Pattern matching identifies query type, routes to appropriate database function, generates Ash-style response with intelligent suggestions.",
                                           },
                                          {"title": "Database Integration",
                                           "content": "Accesses comprehensive played games database with 15+ metadata fields including alternative names, series grouping, and real playtime data.",
                                           },
                                          ],
                             },
            }
