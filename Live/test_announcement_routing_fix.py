                    ...
                    if mock_start.called:
                        ...
                        if message.reply.called:
                            ...
                            if "conversation handler not loaded" in reply_content:
                                self.passed_tests.append(f"✅ Captain Jonesy DM: '{phrase}' → proper error (handler not loaded)")
                            else:
                                self.failed_tests.append(f"❌ Captain Jonesy DM: '{phrase}' → unexpected reply: {reply_content}")
                        else:
                            self.failed_tests.append(f"❌ Captain Jonesy DM: '{phrase}' → no conversation starter or reply")
