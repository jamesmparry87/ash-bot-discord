...
def test_core_modules():
    ...
    try:
        ...
        print(f"   - Pineapple patterns: {len(PINEAPPLE_NEGATIVE_PATTERNS)} patterns")
    ...
    try:
        ...
        if db:
            ...
            try:
                ...
                print(f"   - Database query test: SUCCESS ({len(strikes)} records)")
    ...
    try:
        ...
        print(f"   - Bot package version: {getattr(bot, '__version__', 'Unknown')}")
