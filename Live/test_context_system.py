    ...
    try:
        ...
        for query, expected_type in test_queries:
            ...
            if query_type == expected_type:
                ...
                if match:
                    print(f"   Matched: {match.group(1) if match.lastindex else 'N/A'}")
            else:
                print(f"❌ Query '{query}' incorrectly routed as {query_type}, expected {expected_type}")
...
def main():
    ...
    if tests_passed == total_tests:
        ...
        print("  Bot:  [Resolves context] 'Database analysis: Captain Jonesy invested...'")
    else:
