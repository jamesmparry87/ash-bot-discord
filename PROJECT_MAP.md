...
### `Live/bot/commands/announcements.py`

**Purpose**: Announcement commands
**Edit for**:

- Server-wide announcements
- Emergency alerts
- Monday/Friday content generation
- Announcement approval workflow

### `Live/bot/commands/data_cleanup.py`

**Purpose**: Data cleanup commands
**Edit for**:

- Data normalization (genres, series)
- Deduplication
- Data quality audits
...
### `Live/bot/handlers/context_manager.py`

**Purpose**: Natural language context management
**Edit for**:

- Pronoun resolution (it/she/her)
...
### `Live/bot/integrations/igdb.py`

**Purpose**: IGDB (Internet Game Database) integration
**Edit for**:

- Game name validation
- Game metadata enrichment
- IGDB API interaction
...
### `Live/bot/utils/data_quality.py`

**Purpose**: Data quality utilities
**Edit for**:
...
### `Live/bot/utils/text_processing.py`

**Purpose**: Text processing utilities
**Edit for**:

- Game name extraction from titles
...
| Announcements | `bot/commands/announcements.py` | `bot/handlers/conversation_handler.py` |
